...
class LocationInputView: UIView {
    ...
    func configureViewComponents() {
        ...
        backButton.anchorView(top: topAnchor, left: leftAnchor, paddingTop: 20,
        ...
        startingLocationTextField.anchorView(top: backButton.bottomAnchor, left: leftAnchor, right: rightAnchor,
        ...
        destinationTextField.anchorView(top: startingLocationTextField.bottomAnchor, left: leftAnchor,
        ...
        linkingView.anchorView(top: startLocationIndicatorView.bottomAnchor,
